# HANDOFF · WP-P0-1 ถึง WP-P0-3 (บันทึกประวัติศาสตร์ — ห้ามใช้เป็นสถานะปัจจุบัน)

> ⚠ **2026-08-28: ไฟล์นี้คือบันทึกของวันที่ 27 ส.ค. ไม่ใช่สถานะของระบบ**
> ตัวเลขข้างล่างล้าสมัยหมดแล้ว — เช่น "Tests 7 passed" (ตอนนี้ 245) · "1 migration file" (ตอนนี้ 3)
> และคำสั่ง `npm run privacy:check` ที่ถูกลบทิ้งไปแล้วตาม D-P0-06
> **สถานะจริงอ่านที่ `CLAUDE.md` และ `docs/DECISIONS_P0.md` (ล่าสุด D-P0-14) เท่านั้น**
> เก็บไฟล์นี้ไว้เพราะบทเรียนเรื่อง `spawnSync` บน Windows ยังใช้ได้อยู่
